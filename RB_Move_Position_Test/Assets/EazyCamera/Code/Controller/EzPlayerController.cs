...
public class EzPlayerController : MonoBehaviour 
{
    ...
    private void HandleInput()
    {
        ...
        //Vector3.Lerp(Vector3.zero, moveVector, 0.01f * Time.deltaTime);

        // Move the Player
        m_controlledPlayer.MovePlayer(moveVector.x, moveVector.z, Input.GetKey(KeyCode.LeftShift));
        //if (Input.GetKey(KeyCode.LeftShift))
        //{
        //    m_controlledPlayer.GetComponent<Animator>().SetBool("shift", true);
        //}
        //else
        //{

        //    m_controlledPlayer.GetComponent<Animator>().SetBool("shift", false);
        //}
    }
}
